...
# ind_niftymidsmallcap400list (1).csv
#ind_nifty200list (2)
tickers = pd.read_csv('/Users/kjaswanth/Downloads/ind_niftymicrocap250_list.csv')
...
for stock in rs_stocks:
    ...
    try:
        ...
        low_of_52week = round(min(df["Low"][-252:]), 2)
        high_of_52week = round(max(df["High"][-252:]), 2)
        ...
        condition_8 = currentClose < 10000
        ...
        if(condition_1 and condition_2 and condition_3 and condition_4 and condition_5 and condition_6 and condition_7 and condition_8):
            exportList = exportList.append({'Stock': stock, "RS_Rating": RS_Rating ,"50 Day MA": moving_average_50, "150 Day Ma": moving_average_150, "200 Day MA": moving_average_200, "52 Week Low": low_of_52week, "52 week High": high_of_52week,'CP':CP}, ignore_index=True)
...
MomentumStocks = exportList.iloc[:25]
...
MomentumStocks['Puschare Value'].sum()

st.title("Momentum Investing!")  # add a title
